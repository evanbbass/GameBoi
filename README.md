...
## Update 2025
I've updated the solution and projects to VS2022 and fixed some errors. SFML headers and libraries now included so nuget is no longer needed. This should now build and run in VS2022 (including unit tests) without needing to jump through the hoops mentioned below.
